...
The mean number of daily steps is `r meanSteps`. The median is close to the mean.This is investigated further by plotting the steps as a function of the 5 minute intervals starting at midnight.  
